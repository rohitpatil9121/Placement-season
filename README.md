...
- **Weekly goals.** Every Monday the game sets three targets from your current state (reach a stat, keep a habit on N days, apply to companies, push your weakest DSA topic). Clear all three for a small bonus and a tick-off screen.
- **Batchmates.** Priya, Arjun and Rahul get placed over the season. Their news lands in Recently and on the calendar, and Arjun passes you a referral (no cut-off check) if your networking is 40 or more.
- **Mid-sem week.** Days 36 to 42: study counts double, attending class counts more, DSA fades twice as fast. Striped on the calendar and flagged in the day hero.
- **A DSA skills tree.** Arrays, Graphs, DP and System design instead of one number. Pick the topic on the Practice DSA row; the DSA stat is their average. Each company asks for specific topics and its assessment and interview lean on those, so what you practise is a real choice.
