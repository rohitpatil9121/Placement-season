...
export const COMPANIES: Company[] = [
  { id: 'tcs', name: 'TCS', role: 'Ninja (Systems Engineer)', packageLpa: 3.4, tagline: 'The NQT. Half the college sits for it.', eligibility: { cgpa: 6.0 }, test: 'aptitude', appearsFrom: 20, appearsTo: 70, tier: 1, asks: ['arrays'] },
  { id: 'infosys', name: 'Infosys', role: 'Systems Engineer', packageLpa: 3.6, tagline: 'Mysore campus. Everyone has a cousin who went.', eligibility: { cgpa: 6.5 }, test: 'aptitude', appearsFrom: 22, appearsTo: 72, tier: 1, asks: ['arrays'] },
  { id: 'wipro', name: 'Wipro', role: 'Project Engineer', packageLpa: 3.5, tagline: 'Elite NTH. Aptitude, then a coding round.', eligibility: { cgpa: 6.0 }, test: 'aptitude', appearsFrom: 24, appearsTo: 74, tier: 1, asks: ['arrays'] },
  { id: 'cognizant', name: 'Cognizant', role: 'GenC Programmer Analyst', packageLpa: 4.0, tagline: 'Three rounds. Communication counts.', eligibility: { cgpa: 6.0 }, test: 'aptitude', appearsFrom: 26, appearsTo: 76, tier: 1, asks: ['arrays'] },
  { id: 'accenture', name: 'Accenture', role: 'Associate Software Engineer', packageLpa: 4.5, tagline: 'Cognitive assessment, then a very long form.', eligibility: { cgpa: 6.5 }, test: 'aptitude', appearsFrom: 28, appearsTo: 78, tier: 1, asks: ['arrays'] },
  { id: 'zoho', name: 'Zoho', role: 'Member Technical Staff', packageLpa: 7.0, tagline: 'No CGPA cut-off. Five rounds of pure coding.', eligibility: { dsa: 45 }, test: 'dsa', appearsFrom: 30, appearsTo: 78, tier: 2, asks: ['arrays', 'dp'] },
  { id: 'deloitte', name: 'Deloitte', role: 'Analyst', packageLpa: 7.6, tagline: 'Case questions, then "tell me about a time".', eligibility: { cgpa: 7.0, dsa: 35 }, test: 'aptitude', appearsFrom: 34, appearsTo: 80, tier: 2, asks: ['arrays', 'system'] },
  { id: 'oracle', name: 'Oracle', role: 'Associate Software Engineer', packageLpa: 9.0, tagline: 'SQL, OOP, and one graph question.', eligibility: { cgpa: 7.0, dsa: 50 }, test: 'dsa', appearsFrom: 38, appearsTo: 82, tier: 2, asks: ['graphs', 'system'] },
  { id: 'flipkart', name: 'Flipkart', role: 'SDE-1', packageLpa: 18, tagline: 'Machine coding round. Bring a working laptop.', eligibility: { cgpa: 7.0, dsa: 60, projects: 55 }, test: 'projects', appearsFrom: 45, appearsTo: 84, tier: 3, asks: ['system', 'arrays'] },
  { id: 'amazon', name: 'Amazon', role: 'SDE-1', packageLpa: 20, tagline: 'Leadership Principles. All sixteen of them.', eligibility: { cgpa: 7.0, dsa: 70 }, test: 'dsa', appearsFrom: 50, appearsTo: 86, tier: 3, asks: ['graphs', 'dp'] },
  { id: 'microsoft', name: 'Microsoft', role: 'Software Engineer', packageLpa: 25, tagline: 'Four rounds. The group chat has stopped breathing.', eligibility: { cgpa: 7.5, dsa: 75 }, test: 'dsa', appearsFrom: 55, appearsTo: 86, tier: 3, asks: ['dp', 'system'] },
  { id: 'google', name: 'Google', role: 'Software Engineer', packageLpa: 30, tagline: 'Two coding rounds, then a "Googleyness" chat.', eligibility: { cgpa: 7.5, dsa: 80, projects: 40 }, test: 'dsa', appearsFrom: 62, appearsTo: 88, tier: 3, asks: ['graphs', 'dp', 'system'] },
]
